...
def segment_leaf():
    ...
    # Load the best model.
    best_model = torch.load('./leaf.pth', map_location=torch.device('cpu'))
    ...
    for i in range(len(test_dataset)):
        ...
        save_images(i, image_vis, pr_mask, save_dir='output/health', file_prefix='health')
    return results


if __name__ == '__main__':
    results = segment_leaf()